            ...
            <div class="ad-gallery-container">
                <div class="gallery-card-container">
                    <div class="gallery-card">
                        <img alt="" src="{{ asset('frontend/img/imo-img/ss/1.PNG') }}">
                        <p>Case Study | Arla</p>
                    </div>
                </div>
                <div class="gallery-card-container">
                    <div class="gallery-card">
                        <img alt="" src="{{ asset('frontend/img/imo-img/ss/2.PNG') }}">
                        <p>Case Study | Banglalink</p>
                    </div>
                </div>
                <div class="gallery-card-container">
                    <div class="gallery-card">
                        <img alt="" src="{{ asset('frontend/img/imo-img/ss/3.PNG') }}">
                        <p>Case Study | Berger</p>
                    </div>
                </div>
                <div class="gallery-card-container">
                    <div class="gallery-card">
                        <img alt="" src="imo-img/ss/4.PNG">
                        <p>Case Study | Singer</p>
                    </div>
                </div>
                <div class="gallery-card-container">
                    <div class="gallery-card">
                        <img alt="" src="imo-img/ss/5.PNG">
                        <p>Case Study | Upay</p>
                    </div>
                </div>
                <div class="gallery-card-container">
                    <div class="gallery-card">
                        <img alt="" src="imo-img/ss/6.PNG">
