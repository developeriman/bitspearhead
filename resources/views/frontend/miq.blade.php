            ...
            <div class="ad-gallery-container">
                <div class="gallery-card-container">
                    <div class="gallery-card">
                        <img alt="" src="../miq/img/ss/1.PNG">
                        <p>Case Study | Walton</p>
                    </div>
                </div>
                <div class="gallery-card-container">
                    <div class="gallery-card">
                        <img alt="" src="../miq/img/ss/2.PNG">
                        <p>Case Study | Walton</p>
                    </div>
                </div>
                <div class="gallery-card-container">
                    <div class="gallery-card">
                        <img alt="" src="../miq/img/ss/3.PNG">
                        <p>Case Study | Himalaya</p>
                    </div>
                </div>
                <div class="gallery-card-container">
                    <div class="gallery-card">
                        <img alt="" src="../miq/img/ss/4.PNG">
                        <p>Case Study | Aarong</p>
                    </div>
                </div>
